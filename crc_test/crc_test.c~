...
USHORT usMBCRC16Shift(UCHAR * buf,USHORT length)
{
  USHORT shift,data,val;
  int i;
...
USHORT crc_ccitt(unsigned char *q, int len)
{
  USHORT crc = 0;
...
USHORT SAMO_EncodeDataCRC16( UCHAR *buf, UCHAR dataLen)
{
	UCHAR	i;
	UCHAR	byte;
	USHORT	crc = 0xFFFF;
